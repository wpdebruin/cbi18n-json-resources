...
component {
	...
	// Module Properties
	this.title 				= "cbi18n-json-resources";
	this.author 			= "Wil de Bruin";
	this.webURL 			= "";
	this.description 		= "json language resources in cbi18n";
	this.version			= "1.0.0";
	...
	// Module Entry Point
	this.entryPoint			= "cbi18n-json-resources";
	// Inherit Entry Point
	this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "cbi18n-json-resources";
	// CF Mapping
	this.cfmapping			= "cbi18n-json-resources";
	// Auto-map models
...
//                    "resourceRoot" = "otherResourcePath/lang"
//                }
            },
		...
		interceptorSettings = {
            customInterceptionPoints : "onJsonUnknownTranslation"
		};
